...
CServerDisplayer::CServerDisplayer() // OK
{
	...
	this->m_font = CreateFont(46,0,0,0,FW_SEMIBOLD,0,0,0,ANSI_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH | FF_DONTCARE,"Segoe UI");
	this->m_font2 = CreateFont(24,0,0,0,FW_SEMIBOLD,0,0,0,ANSI_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH | FF_DONTCARE,"Segoe UI");
	...
	this->m_font4 = CreateFont(20,0,0,0,FW_SEMIBOLD,0,0,0,ANSI_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH | FF_DONTCARE,"Segoe UI");
	
	
	this->m_brush[0] = CreateSolidBrush(RGB(71,85,105));
	this->m_brush[1] = CreateSolidBrush(RGB(14,165,139));
	this->m_brush[2] = CreateSolidBrush(RGB(30,64,175));
	this->m_brush[3] = CreateSolidBrush(RGB(15,23,42));
...
void CServerDisplayer::PaintPremium() // OK
{
	...
	SetTextColor(hdc,RGB(255,255,255));//this->m_brush[2]
...
void CServerDisplayer::PaintEventTime() // OK
{
	...
	int posX1 = rect.right-335;
	int posX2 = rect.right-235;

	rect.left	= rect.right-340;
	rect.right	= rect.right-175;
	rect.bottom = 290;
...
void CServerDisplayer::PaintCustomArenaTime() // OK
{
	...
	int posX1 = rect.right-505;
	int posX2 = rect.right-415;

	rect.left	= rect.right-510;
	rect.right	= rect.right-345;
	//rect.top	= 60;
	rect.bottom = 290;
	...
	for(int n=0;n < MAX_LOG_TEXT_LINE;n++)
	{
		switch(this->m_log[count].color)
		{
			...
			case LOG_BLUE:
				...
				break;
			case LOG_BOT:
				SetTextColor(hdc,RGB(244,114,182));
				break;
			case LOG_USER:
