...
#define	CLRDW_GREEN									    ARGB(255, 100, 230, 100)
#define	CLRDW_BR_BLUE									ARGB(255, 168, 148, 255)
#define	CLRDW_BR_OCHER									ARGB(255, 250, 225, 200)
// COLORREF Å¸ÀÙ.
...
extern CTextFont g_pRenderText2;