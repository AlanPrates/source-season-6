...
void CUITextInputBox::GetTextW(wchar_t* pszText, int iGetLenght)
{
	CUITextInputBox_GetTextW(this->m_InputBox, pszText, iGetLenght);
}
void CUITextInputBox::GetText(char* pszText, int iGetLenght)
{
	CUITextInputBox_GetText(this->m_InputBox, pszText, iGetLenght);
}
void CUITextInputBox::SetText(char* pszText)
{
	CUITextInputBox_SetText(this->m_InputBox, pszText);
}
...
{
	return CUITextInputBox_HaveFocus(this->m_InputBox);
}
